...
var Ws = (i, t, e) => t in i ? Us(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
...
var Qs = /* @__PURE__ */ new Set(["top", "bottom"]);
function tt(i) {
...
var nr = async (i, t, e) => {
  ...
  for (let v = 0; v < l.length; v++) {
    ...
    }, k && g <= 50 && (g++, typeof k == "object" && (k.placement && (p = k.placement), k.rects && (c = k.rects === true ? await o.getElementRects({
      reference: i,
      floating: t,
      strategy: s
    }) : k.rects), {
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      if (E = [...E, {
        ...
        if (xt && (!(h === "alignment" ? y !== tt(xt) : false) || // We leave the current main axis only if every placement on that axis
...
var ar = /* @__PURE__ */ new Set(["left", "top"]);
...
function Qn(i) {
  return De() ? i instanceof Node || i instanceof j(i).Node : false;
}
function K(i) {
  return De() ? i instanceof Element || i instanceof j(i).Element : false;
}
function X(i) {
  return De() ? i instanceof HTMLElement || i instanceof j(i).HTMLElement : false;
}
function an(i) {
  return !De() || typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof j(i).ShadowRoot;
}
var ur = /* @__PURE__ */ new Set(["inline", "contents"]);
function he(i) {
  const {
    overflow: t,
    overflowX: e,
...
var hr = /* @__PURE__ */ new Set(["table", "td", "th"]);
function dr(i) {
  return hr.has(ht(i));
}
...
var mr = ["transform", "translate", "scale", "rotate", "perspective"];
var br = ["transform", "translate", "scale", "rotate", "perspective", "filter"];
var gr = ["paint", "layout", "strict", "content"];
function yi(i) {
  const t = _i(), e = K(i) ? H(i) : i;
  return mr.some((n) => e[n] ? e[n] !== "none" : false) || (e.containerType ? e.containerType !== "normal" : false) || !t && (e.backdropFilter ? e.backdropFilter !== "none" : false) || !t && (e.filter ? e.filter !== "none" : false) || br.some((n) => (e.willChange || "").includes(n)) || gr.some((n) => (e.contain || "").includes(n));
}
function vr(i) {
  let t = jt(i);
  for (; X(t) && !Fe(t); ) {
...
var yr = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function Fe(i) {
  return yr.has(ht(i));
}
function H(i) {
...
function Cr(i) {
  ...
  const r = s === "fixed", o = yt(n), l = t ? es(t.floating) : false;
  if (n === o || l && r)
    return e;
  let a = {
    scrollLeft: 0,
...
function kr(i, t) {
  const e = ee(i, true, t === "fixed"), n = e.top + i.clientTop, s = e.left + i.clientLeft, r = X(i) ? zt(i) : ut(1), o = i.clientWidth * r.x, l = i.clientHeight * r.y, a = s * r.x, c = n * r.y;
  return {
    width: o,
    height: l,
    x: a,
...
function ns(i, t) {
  const e = jt(i);
  return e === t || !K(e) || Fe(e) ? false : H(e).position === "fixed" || ns(e, t);
}
function Pr(i, t) {
  const e = t.get(i);
  if (e)
...
function Ir(i, t, e) {
  const n = X(t), s = yt(t), r = e === "fixed", o = ee(i, true, r, t);
  let l = {
    scrollLeft: 0,
    scrollTop: 0
  };
...
var xe = globalThis;
var wi = xe.ShadowRoot && (xe.ShadyCSS === void 0 || xe.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var xi = Symbol();
var un = /* @__PURE__ */ new WeakMap();
var cs = class {
  constructor(t, e, n) {
    if (this._$cssResult$ = true, n !== xi)
...
var Br = (i) => new cs(typeof i == "string" ? i : i + "", void 0, xi);
var S = (i, ...t) => {
...
var hn = wi ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const n of t.cssRules)
    e += n.cssText;
  return Br(e);
})(i) : i;
var { is: jr, defineProperty: Hr, getOwnPropertyDescriptor: Dr, getOwnPropertyNames: Fr, getOwnPropertySymbols: Nr, getPrototypeOf: qr } = Object;
var ct = globalThis;
var dn = ct.trustedTypes;
var Vr = dn ? dn.emptyScript : "";
var Ke = ct.reactiveElementPolyfillSupport;
var Kt = (i, t) => i;
...
var $i = (i, t) => !jr(i, t);
var pn = { attribute: true, type: String, converter: Ee, reflect: false, useDefault: false, hasChanged: $i };
...
var Rt = class extends HTMLElement {
  ...
  C(t, e, { useDefault: n, reflect: s, wrapped: r }, o) {
    n && !(this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Map())).has(t) && (this._$Ej.set(t, o ?? e ?? this[t]), r !== true || o !== void 0) || (this._$AL.has(t) || (this.hasUpdated || n || (e = void 0), this._$AL.set(t, e)), s === true && this._$Em !== t && (this._$Eq ?? (this._$Eq = /* @__PURE__ */ new Set())).add(t));
  }
  async _$EP() {
    ...
    if (!this.hasUpdated) {
      ...
      if (s.size > 0)
        for (const [r, o] of s) {
          ...
          l !== true || this._$AL.has(r) || a === void 0 || this.C(r, void 0, o, a);
        }
    }
    let t = false;
    const e = this._$AL;
...
var Xt = globalThis;
var ke = Xt.trustedTypes;
var fn = ke ? ke.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var us = "$lit$";
var lt = `lit$${Math.random().toFixed(9).slice(2)}$`;
var hs = "?" + lt;
var Ur = `<${hs}>`;
var kt = document;
var ie = () => kt.createComment("");
var ne = (i) => i === null || typeof i != "object" && typeof i != "function";
var Ci = Array.isArray;
var Wr = (i) => Ci(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Xe = `[ 	
\f\r]`;
var Gt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var mn = /-->/g;
var bn = />/g;
var $t = RegExp(`>|${Xe}(?:([^\\s"'>=/]+)(${Xe}*=${Xe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var gn = /'/g;
var vn = /"/g;
var ds = /^(?:script|style|textarea|title)$/i;
var Yr = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var m = Yr(1);
var Pt = Symbol.for("lit-noChange");
var P = Symbol.for("lit-nothing");
var yn = /* @__PURE__ */ new WeakMap();
var Ct = kt.createTreeWalker(kt, 129);
function ps(i, t) {
...
var se = class _se {
  constructor({ strings: t, _$litType$: e }, n) {
    ...
    if (this.el = _se.createElement(c, n), Ct.currentNode = this.el.content, e === 2 || e === 3) {
...
function Ht(i, t, e = i, n) {
  ...
  return (s == null ? void 0 : s.constructor) !== r && ((l = s == null ? void 0 : s._$AO) == null || l.call(s, false), r === void 0 ? s = void 0 : (s = new r(i), s._$AT(i, e, n)), n !== void 0 ? (e._$Co ?? (e._$Co = []))[n] = s : e._$Cl = s), s !== void 0 && (t = Ht(i, s._$AS(i, t.values), s, n)), t;
}
var Qr = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: n } = this._$AD, s = ((t == null ? void 0 : t.creationScope) ?? kt).importNode(e, true);
    Ct.currentNode = s;
...
var de = class _de {
  ...
  constructor(t, e, n, s) {
    this.type = 2, this._$AH = P, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = n, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? true;
  }
  get parentNode() {
  ...
  k(t) {
    ...
    let n, s = 0;
    for (const r of t)
      s === e.length ? e.push(n = new _de(this.O(ie()), this.O(ie()), this, this.options)) : n = e[s], n._$AI(r), s++;
...
var Je = Xt.litHtmlPolyfillSupport;
...
var Fn;
C._$litElement$ = true, C.finalized = true, (Fn = At.litElementHydrateSupport) == null || Fn.call(At, { LitElement: C });
var Ze = At.litElementPolyfillSupport;
Ze == null || Ze({ LitElement: C });
(At.litElementVersions ?? (At.litElementVersions = [])).push("4.2.0");
var to = { attribute: true, type: String, converter: Ee, reflect: false, hasChanged: $i };
var eo = (i = to, t, e) => {
  const { kind: n, metadata: s } = e;
  let r = globalThis.litPropertyMetadata.get(s);
  if (r === void 0 && globalThis.litPropertyMetadata.set(s, r = /* @__PURE__ */ new Map()), n === "setter" && ((i = Object.create(i)).wrapped = true), r.set(e.name, i), n === "accessor") {
    const { name: o } = e;
    return { set(l) {
...
var io = (i) => i.strings === void 0;
var fs = { ATTRIBUTE: 1, CHILD: 2 };
var ms = (i) => (...t) => ({ _$litDirective$: i, values: t });
var bs = class {
  constructor(t) {
  }
  get _$AU() {
...
var Jt = (i, t) => {
  ...
  if (e === void 0)
    return false;
  for (const s of e)
    (n = s._$AO) == null || n.call(s, t, false), Jt(s, t);
  return true;
};
var Pe = (i) => {
  let t, e;
...
var $e = (i, t) => i ? !!((i.provider === "" || i.provider.match(Zt)) && (t && i.prefix === "" || i.prefix.match(Zt)) && i.name.match(Zt)) : false;
function fo(i, t) {
  const e = {};
...
var Yo = (i) => i === "unset" || i === "undefined" || i === "none";
function zs(i, t) {
  const e = {
    ...pe,
    ...i
...
function js() {
  ...
  return {
    enableCache: (e) => Tn(e, true),
    disableCache: (e) => Tn(e, false),
    iconLoaded: $n,
    iconExists: $n,
    getIcon: wo,
    listIcons: _o,
...
function ua(i = "iconify-icon") {
  ...
  const s = [
    ...
    constructor() {
      super();
      at(this, "_shadowRoot");
      at(this, "_initialised", false);
      at(this, "_state");
      at(this, "_checkQueued", false);
      at(this, "_connected", false);
      at(this, "_observer", null);
      at(this, "_visible", true);
    ...
    */
     ...
     */
    _gotIconData(a) {
      this._checkQueued = false, this._renderIcon(a, _n(this), this.getAttribute("mode"));
    }
    /**
...
var _ = class _2 {
  ...
  static init(t = "", e = true) {
    _2.addGlobalStyles(), _2.defineCustomElement("bim-button", ya), _2.defineCustomElement("bim-checkbox", pt), _2.defineCustomElement("bim-color-input", J), _2.defineCustomElement("bim-context-menu", bi), _2.defineCustomElement("bim-dropdown", D), _2.defineCustomElement("bim-grid", ce), _2.defineCustomElement("bim-icon", gi), _2.defineCustomElement("bim-input", Ot), _2.defineCustomElement("bim-label", ft), _2.defineCustomElement("bim-number-input", R), _2.defineCustomElement("bim-option", T), _2.defineCustomElement("bim-panel", nt), _2.defineCustomElement("bim-panel-section", mt), _2.defineCustomElement("bim-selector", bt), _2.defineCustomElement("bim-table", z), _2.defineCustomElement("bim-tabs", W), _2.defineCustomElement("bim-tab", L), _2.defineCustomElement("bim-table-cell", ze), _2.defineCustomElement("bim-table-children", vi), _2.defineCustomElement("bim-table-group", Be), _2.defineCustomElement("bim-table-row", gt), _2.defineCustomElement("bim-text-input", B), _2.defineCustomElement("bim-toolbar", Vt), _2.defineCustomElement("bim-toolbar-group", qt), _2.defineCustomElement(
      "bim-toolbar-section",
      vt
    ), _2.defineCustomElement("bim-viewport", Me), e && this.animateOnLoad(t);
  }
  static newRandomId() {
...
var Ti = (O = class extends C {
  ...
  static removeMenus() {
    for (const t of O.menus)
      t instanceof O && (t.visible = false);
    setTimeout(() => {
...
var F = (Et = class extends C {
  constructor() {
    super(), this.labelHidden = false, this.active = false, this.disabled = false, this.vertical = false, this.tooltipVisible = false, this._stateBeforeLoading = {
      disabled: false,
      icon: ""
    }, this._loading = false, this._parent = Ft(), this._tooltip = Ft(), this._mouseLeave = false, this.onClick = (t) => {
...
var Ri = class Ri2 extends C {
  constructor() {
    super(...arguments), this.vertical = false, this.color = "#bcf124", this.disabled = false, this._colorInput = Ft(), this._textInput = Ft(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Bi = class Bi2 extends Le {
  constructor() {
    super(), this.multiple = false, this.required = false, this.vertical = false, this._visible = false, this._value = /* @__PURE__ */ new Set(), this.onValueChange = new Event("change"), this._contextMenu = Ft(), this.onOptionClick = (t) => {
  ...
  findOption(t) {
    return this._options.find((n) => n instanceof T ? n.label === t || n.value === t : false);
  }
  render() {
    let t, e, n;
...
var Di = class Di2 extends C {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = false, this.slider = false, this._input = Ft(), this.onValueChange = new Event("change");
  }
  set value(t) {
  ...
  onSliderMouseDown(t) {
    ...
    const r = (a) => {
      ...
      document.removeEventListener("mousemove", r), document.body.style.cursor = "default", s ? s = false : (this.addEventListener("blur", o), this.slider = false, requestAnimationFrame(() => this.focus())), document.removeEventListener("mouseup", l);
    };
...
var Ni = class Ni2 extends C {
  ...
  handelSlotChange(t) {
    t.target.assignedElements({ flatten: true }).forEach((s, r) => {
      const o = r * 0.05;
...
var qi = class qi2 extends C {
  ...
  onSlotChange(t) {
    const e = t.target.assignedElements();
    for (const n of e)
      n instanceof T && (n.noMark = true, n.removeEventListener("click", this.onOptionClick), n.addEventListener("click", this.onOptionClick));
  }
  findOption(t) {
    return this._options.find((n) => n instanceof T ? n.label === t || n.value === t : false);
  }
...
var Qi = class Qi2 extends C {
  ...
  onSlotChange(t) {
    ...
    const e = t.target.assignedElements(), n = e.find((s) => s instanceof L ? this.tab ? s.name === this.tab : !s.hidden : false);
