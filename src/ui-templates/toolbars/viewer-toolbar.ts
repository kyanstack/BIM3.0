...
> = (state) => {
  ...
  if (world.camera instanceof OBC.SimpleCamera) {
    ...
    focusBtn = BUI.html`<bim-button tooltip-title=${tooltips.FOCUS.TITLE_ZH} tooltip-text=${tooltips.FOCUS.TEXT_ZH} icon=${appIcons.FOCUS} label="聚焦" @click=${onFocus}></bim-button>`;
  }
  ...
  return BUI.html`
    <bim-toolbar>
      <bim-toolbar-section label="可见性" icon=${appIcons.SHOW}>
        <bim-button tooltip-title=${tooltips.SHOW_ALL.TITLE_ZH} tooltip-text=${tooltips.SHOW_ALL.TEXT_ZH} icon=${appIcons.SHOW} label="显示全部" @click=${onShowAll}></bim-button> 
        <bim-button tooltip-title=${tooltips.GHOST.TITLE_ZH} tooltip-text=${tooltips.GHOST.TEXT_ZH} icon=${appIcons.TRANSPARENT} label="切换幽灵模式" @click=${onToggleGhost}></bim-button>
      </bim-toolbar-section> 
      <bim-toolbar-section label="选择" icon=${appIcons.SELECT}>
        ${focusBtn}
        <bim-button tooltip-title=${tooltips.HIDE.TITLE_ZH} tooltip-text=${tooltips.HIDE.TEXT_ZH} icon=${appIcons.HIDE} label="隐藏" @click=${onHide}></bim-button> 
